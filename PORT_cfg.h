...
#ifndef DIOPORT_REG_H_
#define DIOPORT_REG_H_
...
/*
 * if input 0 push pull , if output low
 */
...
#define PORTD_PIN0_VAL          1
#define PORTD_PIN1_VAL          1
#define PORTD_PIN2_VAL          1
#define PORTD_PIN3_VAL          1
#define PORTD_PIN4_VAL          1
#define PORTD_PIN5_VAL          1
#define PORTD_PIN6_VAL          1
#define PORTD_PIN7_VAL          1


#endif /* DIOPORT_REG_H_ */
